...
@app.route('/dataset/')
def datas():
   con = sql.connect("/home/sakshi/proj/test.db")
...
def predict():
    ...
    if request.method == 'POST':
        ...
        pepdesc = PeptideDescriptor('/home/sakshi/proj/random.fasta', 'eisenberg')  # use Eisenberg consensus scale
        globdesc = GlobalDescriptor('/home/sakshi/proj/random.fasta')
